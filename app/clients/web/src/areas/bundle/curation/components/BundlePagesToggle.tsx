...
const BundlePagesToggle: React.FC<{
  isActive: boolean;
  onToggle: () => void;
  onHoverStart?: () => void;
  onHoverEnd?: () => void;
  ...
  return (
    <div className="flex items-center gap-1.5">
      <span className="text-xs text-gray-500 select-none cursor-default">Bundle Pages</span>
      <button
        ref={buttonRef}
        role="switch"
      ...
      {hovered && tooltipPos && createPortal(
        ...
        >
          Show the exact pages that will be published to the bundle.<br /><br />They are the ones that are tracked and not blacklisted.
        </div>,
        document.body
      )}
    </div>
...
export default BundlePagesToggle;
