...
const CustomFilterModal: React.FC<CustomFilterModalProps> = ({
  ...
  const [filterScope, setFilterScope] = useState<'global' | 'bundle'>('bundle');
  const [selectors, setSelectors] = useState<CustomBundleNodeSelectorConfig[]>([
  ...
  const updateSelector = (index: number, updates: Partial<CustomBundleNodeSelectorConfig>) => {
      ...
      <div className="flex flex-col h-full">
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <select
              value={filterScope}
              onChange={(e) => setFilterScope(e.target.value as 'global' | 'bundle')}
              className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-1 focus:ring-inset focus:ring-blue-500"
            >
              <option value="bundle">Bundle-specific</option>
              <option value="global">Global (all bundles)</option>
            </select>
          </div>
