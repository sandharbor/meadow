...
import { normalizeFolderSourceGraphSubdirectory } from '../../../../shared_code/utils/siteNodeConfigUtils.js';

export const FOLDER_SITE_HIGH_IMPACT_SEED_FILES = 1_000;
export const FOLDER_SITE_HIGH_IMPACT_RAW_NODES = 5_000;
export const FOLDER_SITE_MAX_RAW_NODES = 25_000;
export const FOLDER_SITE_MAX_TYPED_EDGES = 100_000;

export function canonicalFolderSiteSourceDirectory(sourceDirectory: string): string {
