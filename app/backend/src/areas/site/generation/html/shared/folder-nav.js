(function() {
  ...
  var siteRoot = runtimeScript && runtimeScript.src
  ...
  function applyInitialLayout() {
    ...
    try {
      ...
      // Use responsive defaults when site storage is unavailable.
    }
  ...
  function renderNavigationTree(sidebar) {
    ...
    function renderFile(file) {
      ...
      link.setAttribute('href', new URL(encodedPath(file.path), siteRoot).href);
  ...
  function start() {
    ...
    function saveState() {
      try {
        ...
        // a browser with blocked site storage); only persistence is skipped.
      }
    }
