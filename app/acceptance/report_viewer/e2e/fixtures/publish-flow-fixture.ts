...
// `app/acceptance/e2e/tests/meadow-extension/publish-flow.spec.ts`. This artifact is the
...
const PUBLISH_FLOW_SPEC = path.join(
  REPO_ROOT,
  "app/acceptance/e2e/tests/meadow-extension/publish-flow.spec.ts"
);
const TEST_RUNNER_DIR = path.join(REPO_ROOT, "app/acceptance/e2e");
