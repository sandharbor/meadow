...
interface SettingRowProps {
  ...
  onBundleSettingChange: (setting: OverrideSetting) => void;
...
export const SettingRow: React.FC<SettingRowProps> = ({
  ...
  globalValue,
  bundleSetting,
  onBundleSettingChange,
  action,
  disabled,
  dimmed,
  tooltip,
}) => {
  const effectiveValue = bundleSetting === 'inherit' ? globalValue : bundleSetting === 'enabled';
  ...
  return (
    ...
    >
      ...
      <select
        value={bundleSetting}
        onChange={(e) => onBundleSettingChange(e.target.value as OverrideSetting)}
        disabled={disabled}
