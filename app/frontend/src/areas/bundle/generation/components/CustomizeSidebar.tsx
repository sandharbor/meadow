        ...
        <div className="flex-1 overflow-y-auto" ref={scrollContainerRef}>
          ...
          <div className="mb-4 px-1 pt-2">
            <GenerationOptionsPanel
              ...
              bundleOptions={bundleGenerationOptions}
              ...
              onBundleSrsTagsChange={onBundleSrsTagsChange}
          ...
          <div className="mb-4 px-1 border-t pt-4">
            <CustomAssetsPanel key={`assets-${refreshKey}`} bundleSlug={bundleSlug} onCustomAssetsChanged={onCustomAssetsChanged} />
          </div>
          <div className="px-1 border-t pt-4 pb-4">
            <HooksPanel key={`hooks-${refreshKey}`} bundleSlug={bundleSlug} onHooksChanged={onHooksChanged} />
          </div>
          <div className="px-1 border-t pt-4 pb-4">
            <div className="px-2">
