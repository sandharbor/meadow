    ...
    >
      <div className="space-y-5">
        <p className="text-sm text-neutral-600">
          These settings apply to this bundle. Choose how OKF should fill the reserved root <code className="rounded bg-neutral-100 px-1 py-0.5">index.md</code> and <code className="rounded bg-neutral-100 px-1 py-0.5">log.md</code> files.
        </p>
            ...
            <label className={`rounded border p-3 ${indexMode === 'trackedPage' ? 'border-main-300 bg-main-50' : 'border-neutral-200 bg-white'}`}>
              <div className="flex items-start gap-2">
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <div className="text-xs text-neutral-600">Only pages currently in this bundle&apos;s working graph are available.</div>
