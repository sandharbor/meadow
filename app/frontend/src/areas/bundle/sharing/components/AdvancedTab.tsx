...
export const AdvancedTab: React.FC<AdvancedTabProps> = ({ bundleSlug }) => {
  ...
  const pathRows = [
    ...
    { label: 'Bundle Config', path: paths.bundleConfigFile },
    { label: 'Bundle Page Config', path: paths.bundleNodeConfigFile },
    { label: 'Sources', path: paths.rawMarkdown },
    { label: 'Generated HTML Bundle', path: paths.generatedHtml },
  ];
