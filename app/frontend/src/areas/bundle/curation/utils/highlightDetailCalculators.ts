 ...
 */
export function calculateOutlinkGapDetail(page: IBundleNode, graph: Graph): string {
 ...
 */
export function calculateInlinkGapDetail(page: IBundleNode, graph: Graph): string {
 ...
 */
export function calculateOverridesDetail(page: IBundleNode): string {
