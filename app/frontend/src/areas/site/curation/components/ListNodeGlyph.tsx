...
import SiteNodeGlyph from './SiteNodeGlyph';

const nodeKindLabel = (node: DisplayNode): string => {
  if (node.siteNodeKind === 'collection') return 'Site home';
  if (node.siteNodeKind === 'folder') return 'Folder';
  return 'File';
};
...
const ListNodeGlyph: React.FC<{
  ...
  <svg
    ...
    data-node-kind={node.siteNodeKind}
