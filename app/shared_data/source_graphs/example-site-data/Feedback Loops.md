...
What's the difference between positive and negative [[Feedback Loops|feedback loops]]?
?
Positive (reinforcing) loops amplify change; negative (balancing) loops dampen change and push toward equilibrium.


Why does a bank run illustrate a positive [[Feedback Loops|feedback loop]]?
?
A few worried depositors cause more worry, which accelerates withdrawals, which causes more worry — the output amplifies the input.
