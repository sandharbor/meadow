...
What role do "reality check" models like [[Circle of Competence]] and [[Occam's Razor]] play compared to "thinking tools" like [[Inversion]]?
?
Thinking tools structure your reasoning; reality checks keep it grounded.


According to [[Charlie Munger]], what is the goal of building a [[Latticework of Mental Models|latticework of mental models]]?
?
To have the right model surface when needed — not to use every model on every problem.
