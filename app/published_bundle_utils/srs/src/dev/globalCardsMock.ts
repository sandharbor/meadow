...
/**
 * Build a mock srs-all-cards.json payload for a given bundleGuid.
 ...
 */
export function devGlobalCards(bundleGuid: string): { version: number; bundleGuid: string; cards: GlobalCardEntry[] } {
  ...
  return { version: 1, bundleGuid, cards: allCards };
}
