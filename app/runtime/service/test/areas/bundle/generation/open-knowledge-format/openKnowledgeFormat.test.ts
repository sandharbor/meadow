...
function pageConfig(title: string, dir = ''): BundleNodeConfig {
  return makeBundleNodeConfig(title, 'whitelist', { sourceGraphSubdirectory: dir });
}
...
describe('prepareOpenKnowledgeFormatDirectoryFromScrubbedSourceDirectory', () => {
  ...
  it('writes concepts with merged frontmatter and bundle-root markdown links', () => {
    ...
    prepareOpenKnowledgeFormatDirectoryFromScrubbedSourceDirectory(scrubbedDir, okfDir, {
      bundleNodeConfigs: [pageConfig('main page'), pageConfig('connected page')],
  ...
  it('strips okf prefixes from concept frontmatter properties', () => {
    ...
    prepareOpenKnowledgeFormatDirectoryFromScrubbedSourceDirectory(scrubbedDir, okfDir, {
      bundleNodeConfigs: [pageConfig('main page')],
      entryNodeName: 'main page',
      entrySourceGraphSubdirectory: '',
    });
  ...
  it('can map an arbitrary tracked page to root log.md', () => {
    ...
    prepareOpenKnowledgeFormatDirectoryFromScrubbedSourceDirectory(scrubbedDir, okfDir, {
      bundleNodeConfigs: [pageConfig('home'), pageConfig('updates')],
      entryNodeName: 'home',
      entrySourceGraphSubdirectory: '',
  ...
  it('can map a tracked source page to root index.md without renaming that source page', () => {
    ...
    prepareOpenKnowledgeFormatDirectoryFromScrubbedSourceDirectory(scrubbedDir, okfDir, {
      bundleNodeConfigs: [pageConfig('home'), pageConfig('index')],
      entryNodeName: 'home',
      entrySourceGraphSubdirectory: '',
  ...
  it('renames a source index.md when another tracked page is mapped to root index.md', () => {
    ...
    prepareOpenKnowledgeFormatDirectoryFromScrubbedSourceDirectory(scrubbedDir, okfDir, {
      bundleNodeConfigs: [pageConfig('home'), pageConfig('index'), pageConfig('custom index')],
      entryNodeName: 'home',
      entrySourceGraphSubdirectory: '',
  ...
  it('can write the same tracked source page to root index.md and log.md', () => {
    ...
    prepareOpenKnowledgeFormatDirectoryFromScrubbedSourceDirectory(scrubbedDir, okfDir, {
      bundleNodeConfigs: [pageConfig('home'), pageConfig('release notes')],
      entryNodeName: 'home',
      entrySourceGraphSubdirectory: '',
  ...
  it('omits log.md when the log source mode is none', () => {
    ...
    prepareOpenKnowledgeFormatDirectoryFromScrubbedSourceDirectory(scrubbedDir, okfDir, {
      bundleNodeConfigs: [pageConfig('home'), pageConfig('log')],
      entryNodeName: 'home',
      entrySourceGraphSubdirectory: '',
      logSource: { mode: 'none' },
    });
