...
describe('html preview', () => {
  ...
  const excalidrawInitialSetup = new TestBundleSetup('areas/bundle/generation/fixtures/excalidraw-initial-bundle', 'excalidraw-initial-test-bundle');
  ...
  it('generates bundle search assets and a sharded index by default', async () => {
    ...
    expect(mainPageHtml).toContain('aria-label="Search this bundle"');
