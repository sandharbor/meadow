...
describe('Nodespecs Curation System Tests', () => {
  describe('Curation YAML Validation Tests', () => {
    ...
    it('all curation nodespecs should pass validation with no curation errors', () => {
      const availableBundles = getAvailableBundles();
      const errors: string[] = [];
      ...
      if (errors.length > 0) {
        throw new Error(`Curation nodespec validation errors:\n${errors.join('\n')}`);
      }
    });
  });
...
describe('Runtime Nodespec Curation Validation', () => {
  ...
  beforeEach(() => {
    bigBundleSetup = new SystemTestBundleSetup(
      ...
      'nodespec-curation-validation-big',
    ...
    smallBundleSetup = new SystemTestBundleSetup(
      'home_fixture_big_and_small',
      'nodespec-curation-validation-small',
    ...
    exampleBundleSetup = new SystemTestBundleSetup(
      ...
      'nodespec-curation-validation-example',
    ...
    folderStructureSingleSetup = new SystemTestBundleSetup(
      ...
      'nodespec-curation-validation-folder-single',
    ...
    folderStructureMultipleSetup = new SystemTestBundleSetup(
      ...
      'nodespec-curation-validation-folder-multiple',
  ...
  it('should validate nodespec curation links match actual working graph links', async () => {
