...
/**
 * Page object for the shared Delete Bundle confirmation modal.
 *
 * This modal appears when deleting a bundle from either the BundleList
 * (trash icon) or the BundleEditor (bundle options menu → Delete bundle).
 */
export class DeleteBundleModal {
  constructor(
    private page: Page,
