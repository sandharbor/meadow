A filter combines a [[filter page selector]] with one or more [[filter action]]s.

At a very high level, the ultimate aim of these filters is to help a user turn a [[raw working graph]] into a [[tracked working graph]] that is ready to publish.
