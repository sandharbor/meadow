...
Finally, in the [[app component - modal -- bundle preview -- publish tab|publish to meadow tab]] we copy that [[generated html bundle]] to the [[published bundle type -- local html]] and then upload it to [[published bundle type -- remote html|the files on S3]].