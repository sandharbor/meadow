...
:
You can use it to create a list of filenames.  Those filenames could help you move pages into a different [[source graph subdirectory]], for example using custom programs.
:
...
...
Sometimes an area of interest is no longer interesting, and you'd really like to [[archive]] it, but it's hard to see if it is connected to other parts of your notes. This is particularly true if you did it as a project, but weren't super careful about putting it into a folder.
...
Let's things grow organically in your notes from incipient small bits and scraps to bigger things without imposing too much structure early on, but allows you to ref factor to greater structure after-the-fact.
