^ [[app component -- sidebar]] -- customize preview
...
[[custom HTML templates and CSS overrides]]

### Hooks

[[hooks config]] and _link not tracked_
...
At the bottom there is [[Custom Assets & Hooks Agent Prompt]]
